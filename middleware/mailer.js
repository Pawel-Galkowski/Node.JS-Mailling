        ...
        transporter.sendMail({
          ...
          <div style="max-width: 600px; min-width: 300px: width: auto; margin: 0 auto; text-align: center;">
              <p style="text-align: left;">
                  ...
                  Thanks for signing up with JoinJobs! <br />In order to activate your account, we require that you confirm your email address.
              </p>
              <a href="${url}" style="padding: 10px 20px; width: 250px; height: 60px; background-color: #00BFFF; border-radius:10px; border: none; color: white; font-size: 20px; font-weight: bold; text-decoration:none;">Confirmation</a>
              <p style="text-align: left;">
